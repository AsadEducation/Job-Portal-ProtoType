...
const Login = () => {
    ...
    return (
        <div className="lg:flex items-center lg:w-[50%] mx-auto">
            <div className="w-full max-w-md p-4 rounded-md shadow sm:p-8 dark:bg-gray-50 dark:text-gray-800">
                <h2 className="mb-3 text-3xl font-semibold text-center">Login to your account</h2>
                <p className="text-sm text-center dark:text-gray-600">Don't have account?
                    <Link to={`/auth/register`} rel="noopener noreferrer" className="focus:underline hover:underline">Sign up here</Link>
                </p>
                ...
                <form onSubmit={handleFormSubmit} noValidate="" action="" className="space-y-8">
                    ...
                    <button className="w-full px-8 py-3 font-semibold rounded-md dark:text-gray-50 dark:bg-violet-600">Sign in</button>
                </form>
            </div>
